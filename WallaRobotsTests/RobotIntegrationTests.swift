...
struct RobotIntegrationTests {
    ...
    func testFullUserFlow_LoadPaginateSearchAndClear() async throws {
        ...
        let mockService = FakeRobotService.previewService
        ...
        // Verify we have robots from both pages
        ...
        viewModel.debouncedSearchText = searchTerm // Simulate debounce completion
    ...
    func testMultiplePaginations() async {
        ...
        while viewModel.hasMoreData {
            ...
            // Safety limit to prevent infinite loops (1000 robots / 20 per page = 50 pages max)
            if paginationCount > 50 { break }
        }

        // THEN: All robots should be loaded
        let totalMockRobots = FakeRobotService.loadMockRobots().count
    ...
    func testSearchPreservesPaginationState() async {
        ...
        _ = viewModel.filteredRobots // Trigger filter
